...
apt = view:option(Value, "apt", "Repository URL:", "Preset URL above last tested on Q1 2022."); view.optional=false; view.rmempty = false;
...
function upd.write()
  luci.sys.call("sh /usr/lib/speedifyconf/run.sh update >> /usr/lib/speedifyconf/speedifyconfig.log &")
end

function rst.write()
  luci.sys.call("rm -rf /usr/share/speedify/logs && sh /usr/lib/speedifyconf/run.sh >> /usr/lib/speedifyconf/speedifyconfig.log &")
end
