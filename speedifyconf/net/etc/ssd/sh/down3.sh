tac /tmp/spdstat.log | sed -n '/receiveBps/{nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn;p;q}' | awk -F '"' {'print $4'} | cut -c 0 | tr -d '\n'
echo -n ":"
