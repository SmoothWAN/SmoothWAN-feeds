...
upd = view:option(Button, "_update", "Trigger Install/Update", "Clients need to reconnect to obtain Pi-hole DNS after first install only.<br>Pi-hole Admin page: <a href='http://172.17.17.3/admin' target='_blank'>http://172.17.17.3/admin</a>")
