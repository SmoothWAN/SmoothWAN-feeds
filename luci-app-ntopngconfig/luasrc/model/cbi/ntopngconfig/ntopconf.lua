...
download = view:option(Button, "_download", "Download / Update Ntopng", "Downloads a <a href='https://github.com/SmoothWAN/SmoothWAN-chroot-imagebuilder'>pre-installed Ntopng in a Debian container</a> to internal storage.<br>Requires at least 2GB of free space.<br>Routers: Go to the Guide tab for external storage setup.")
